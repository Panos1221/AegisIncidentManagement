...
namespace IncidentManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250922122617_AddInjuryAndDeathTables")]
    partial class AddInjuryAndDeathTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IncidentManagement.Domain.Entities.Death", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("IncidentCasualtyId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IncidentManagement.Domain.Entities.IncidentCasualty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DeadCivilians")
                        .HasColumnType("int");

                    b.Property<int?>("DeadFiremen")
                        .HasColumnType("int");

                    b.Property<string>("DeadPersonName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("DeadPersonType")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<int?>("InjuredCivilians")
                        .HasColumnType("int");

                    b.Property<int?>("InjuredFiremen")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("InjuredPersonType")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.ToTable("IncidentCasualties");
                });

            modelBuilder.Entity("IncidentManagement.Domain.Entities.IncidentCommander", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("IncidentCommanders");
                });

            modelBuilder.Entity("IncidentManagement.Domain.Entities.IncidentDamage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("SavedProperty")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("IncidentManagement.Domain.Entities.IncidentFire", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("BurnedArea")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("BurnedItems")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.ToTable("IncidentFires");
                });

            modelBuilder.Entity("IncidentManagement.Domain.Entities.IncidentInvolvement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("FirePersonnel")
                        .HasColumnType("int");

                    b.Property<int?>("FireTrucksNumber")
                        .HasColumnType("int");

                    b.Property<int>("IncidentId")
                        .HasColumnType("int");

                    b.Property<string>("OtherAgencies")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("RescueInformation")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<int?>("RescuedPeople")
                        .HasColumnType("int");

                    b.Property<string>("ServiceActions")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("IncidentManagement.Domain.Entities.Injury", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IncidentManagement.Domain.Entities.Death", b =>
                {
                    b.HasOne("IncidentManagement.Domain.Entities.IncidentCasualty", "IncidentCasualty")
                        .WithMany("Deaths")
                        .HasForeignKey("IncidentCasualtyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("IncidentCasualty");
                });
            ...
            modelBuilder.Entity("IncidentManagement.Domain.Entities.IncidentCasualty", b =>
                {
                    b.HasOne("IncidentManagement.Domain.Entities.Incident", "Incident")
                        .WithOne("Casualty")
                        .HasForeignKey("IncidentManagement.Domain.Entities.IncidentCasualty", "IncidentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IncidentManagement.Domain.Entities.IncidentCommander", b =>
                {
                    b.HasOne("IncidentManagement.Domain.Entities.User", "AssignedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("IncidentManagement.Domain.Entities.IncidentDamage", b =>
                {
                    b.HasOne("IncidentManagement.Domain.Entities.Incident", "Incident")
                        .WithOne("Damage")
                        .HasForeignKey("IncidentManagement.Domain.Entities.IncidentDamage", "IncidentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IncidentManagement.Domain.Entities.IncidentFire", b =>
                {
                    b.HasOne("IncidentManagement.Domain.Entities.Incident", "Incident")
                        .WithOne("Fire")
                        .HasForeignKey("IncidentManagement.Domain.Entities.IncidentFire", "IncidentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IncidentManagement.Domain.Entities.IncidentInvolvement", b =>
                {
                    b.HasOne("IncidentManagement.Domain.Entities.Incident", "Incident")
                        .WithOne("Involvement")
                        .HasForeignKey("IncidentManagement.Domain.Entities.IncidentInvolvement", "IncidentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
