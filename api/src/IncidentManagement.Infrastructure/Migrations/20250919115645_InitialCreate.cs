...
namespace IncidentManagement.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CoastGuardStations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    NameGr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoastGuardStations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FireHydrants", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitude = table.Column<double>(type: "float", nullable: false),
                    Longitude = table.Column<double>(type: "float", nullable: false),
                    AgencyCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Address = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    Sinoikia = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Diam = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Latitude = table.Column<double>(type: "float", nullable: false),
                    Longitude = table.Column<double>(type: "float", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                name: "StationBoundaries",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FireStationId = table.Column<int>(type: "int", nullable: false),
                    CoordinatesJson = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StationBoundaries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StationBoundaries_FireStations_FireStationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceTemplateName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShiftInstances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShiftInstances_Stations_StationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RRule = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShiftTemplates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShiftTemplates_Stations_StationId",
                        column: x => x.StationId,
                        principalTable: "Stations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SupabaseUserId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WaterLevelLiters = table.Column<double>(type: "float", nullable: true),
                    WaterCapacityLiters = table.Column<double>(type: "float", nullable: true),
                    FoamLevelLiters = table.Column<double>(type: "float", nullable: true),
                    FuelLevelPercent = table.Column<int>(type: "int", nullable: true),
                    BatteryVoltage = table.Column<double>(type: "float", nullable: true),
                    PumpPressureKPa = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Incidents_Agencies_AgencyId",
                        column: x => x.AgencyId,
                        principalTable: "Agencies",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatrolZones_Agencies_AgencyId",
                        column: x => x.AgencyId,
                        principalTable: "Agencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PatrolZones_Stations_StationId",
                        column: x => x.StationId,
                        principalTable: "Stations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PatrolZones_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Personnel_Stations_StationId",
                        column: x => x.StationId,
                        principalTable: "Stations",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnRouteAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    OnSceneAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "PatrolZoneAssignments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PatrolZoneId = table.Column<int>(type: "int", nullable: false),
                    VehicleId = table.Column<int>(type: "int", nullable: false),
                    AssignedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UnassignedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    AssignedByUserId = table.Column<int>(type: "int", nullable: false),
                    UnassignedByUserId = table.Column<int>(type: "int", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatrolZoneAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatrolZoneAssignments_PatrolZones_PatrolZoneId",
                        column: x => x.PatrolZoneId,
                        principalTable: "PatrolZones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PatrolZoneAssignments_Users_AssignedByUserId",
                        column: x => x.AssignedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PatrolZoneAssignments_Users_UnassignedByUserId",
                        column: x => x.UnassignedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PatrolZoneAssignments_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleAssignments_Personnel_PersonnelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoastGuardStations_Latitude_Longitude",
                table: "CoastGuardStations",
                columns: new[] { "Latitude", "Longitude" });

            migrationBuilder.CreateIndex(
                name: "IX_FireHydrants_ExternalId",
                table: "FireHydrants",
                column: "ExternalId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FireHydrants_Latitude_Longitude",
                table: "FireHydrants",
                columns: new[] { "Latitude", "Longitude" });

            migrationBuilder.CreateIndex(
                name: "IX_FireStations_Latitude_Longitude",
                table: "FireStations",
                columns: new[] { "Latitude", "Longitude" });

            migrationBuilder.CreateIndex(
                name: "IX_Hospitals_AgencyCode",
                table: "Hospitals",
                column: "AgencyCode");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatrolZoneAssignments_AssignedByUserId",
                table: "PatrolZoneAssignments",
                column: "AssignedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PatrolZoneAssignments_PatrolZoneId",
                table: "PatrolZoneAssignments",
                column: "PatrolZoneId");

            migrationBuilder.CreateIndex(
                name: "IX_PatrolZoneAssignments_UnassignedByUserId",
                table: "PatrolZoneAssignments",
                column: "UnassignedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PatrolZoneAssignments_VehicleId",
                table: "PatrolZoneAssignments",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_PatrolZones_AgencyId",
                table: "PatrolZones",
                column: "AgencyId");

            migrationBuilder.CreateIndex(
                name: "IX_PatrolZones_CreatedByUserId",
                table: "PatrolZones",
                column: "CreatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PoliceStations_Gid",
                table: "PoliceStations",
                column: "Gid");

            migrationBuilder.CreateIndex(
                name: "IX_PoliceStations_Latitude_Longitude",
                table: "PoliceStations",
                columns: new[] { "Latitude", "Longitude" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftInstances_StationId",
                table: "ShiftInstances",
                column: "StationId");

            migrationBuilder.CreateIndex(
                name: "IX_ShiftTemplates_StationId",
                table: "ShiftTemplates",
                column: "StationId");

            migrationBuilder.CreateIndex(
                name: "IX_StationBoundaries_FireStationId",
                table: "StationBoundaries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleAssignments_PersonnelId",
